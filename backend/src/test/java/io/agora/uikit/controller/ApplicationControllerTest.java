...
public class ApplicationControllerTest {
    ...
    @Test
    public void testCreateApplicationErrorParamsRoomId() throws Exception {
        log.info("testCreateApplicationErrorParamsRoomId,roomId:{},userId:{}", roomId, normalUserId);

        JSONObject json = new JSONObject();
        json.put("fromUserId", normalUserId);
        json.put("payload", new MicSeatPayload()
                .setSeatNo(1)
                .setDesc("test"));

        mockMvc.perform(MockMvcRequestBuilders.post("/v1/application/create")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json.toJSONString()))
    ...
    @Test
    public void testCreateApplicationErrorParamsFromUserId() throws Exception {
        log.info("testCreateApplicationErrorParamsFromUserId,roomId:{},userId:{}", roomId, normalUserId);
    ...
    @Test
    public void testCreateApplicationErrorParamsPayload() throws Exception {
        log.info("testCreateApplicationErrorParamsFromUserId,roomId:{},userId:{}", roomId, normalUserId);
    ...
    @Test
    public void testAcceptApplicationErrorParamsRoomId() throws Exception {
        log.info("testAcceptApplicationErrorParamsRoomId,roomId:{},userId:{}", roomId, roomOwnerUserId);

        JSONObject json = new JSONObject();
        json.put("fromUserId", roomOwnerUserId);
        json.put("toUserId", normalUserId);
        mockMvc.perform(MockMvcRequestBuilders.post("/v1/application/accept")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json.toJSONString()))
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value(HttpStatus.BAD_REQUEST.value()))
    ...
    @Test
    public void testAcceptApplicationErrorParamsFromUserId() throws Exception {
        log.info("testAcceptApplicationErrorParamsFromUserId,roomId:{},userId:{}", roomId, roomOwnerUserId);
    ...
    @Test
    public void testAcceptApplicationErrorParamsToUserId() throws Exception {
        log.info("testAcceptApplicationErrorParamsToUserId,roomId:{},userId:{}", roomId, roomOwnerUserId);
    ...
    @Test
    public void testEndApplicationErrorParamsRoomId() throws Exception {
        log.info("testRemoveApplicationErrorParamsRoomId,roomId:{},userId:{}", roomId, roomOwnerUserId);

        JSONObject json = new JSONObject();
        json.put("fromUserId", roomOwnerUserId);
        json.put("toUserId", normalUserId);
        mockMvc.perform(MockMvcRequestBuilders.post("/v1/application/cancel")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json.toJSONString()))
                .andExpect(MockMvcResultMatchers.status().isBadRequest())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value(HttpStatus.BAD_REQUEST.value()))
    ...
    @Test
    public void testEndApplicationErrorParamsFromUserId() throws Exception {
        log.info("testRemoveApplicationErrorParamsFromUserId,roomId:{},userId:{}", roomId, roomOwnerUserId);
    ...
    @Test
    public void testEndApplicationErrorParamsToUserId() throws Exception {
        log.info("testEndApplicationErrorParamsToUserId,roomId:{},userId:{}", roomId, roomOwnerUserId);
