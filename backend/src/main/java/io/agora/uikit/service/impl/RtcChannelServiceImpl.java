...
public class RtcChannelServiceImpl implements IRtcChannelService {
    ...
    @Override
    public void kickOut(String appId, String cname, Long uid, Integer time, List<String> privileges) throws Exception {
        ...
        CreateKickOutRuleDto kickOutRuleDTO = rtcChannelAPIService.createKickOutRule(rule);
